  ...
  return (
    <>
      <section className={styles["section__container"]}>
        <h1 className={styles["titulo-Home"]}>Game of Trons</h1>
      </section>

      <section className={styles["section__container"]}>
        <h2><span role="img" aria-label="cohete espacial">🌌</span> Journey into the Future</h2>
      ...
      <section className={styles["section__container"]}>
        <h2><span role="img" aria-label="cohete espacial">🌍</span> From Neglect to Innovation</h2>
      ...
      <section className={styles["section__container"]}>
        <h2><span role="img" aria-label="cohete espacial">🚀</span> Enter Space Travel: Where Dreams Take Flight</h2>
      ...
      <section className={styles["section__container"]}>
        <h2><span role="img" aria-label="cohete espacial">🔧</span> Engineer, Explorer, Leader</h2>
      ...
      <section className={styles["section__container"]}>
        <h2><span role="img" aria-label="cohete espacial">🌠</span> A Universe of Possibilities Awaits</h2>
